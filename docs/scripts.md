...
| `fm-bearings-snapshot.sh` | Project fleet state and managed PR truth to compact TOON under the bounds in its header |
...
| [`fm-dod-lib.sh`](../bin/fm-dod-lib.sh) | Own worker roles, ship completion, private intent, and PR publication and review |
