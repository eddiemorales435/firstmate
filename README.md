...
| `/bearings`        | Summarize fleet state and managed PR truth with the [Bearings skill](.agents/skills/bearings/SKILL.md) |
...
- `/bearings include PRs` keeps chat-only mode and adds review and CI detail.
...
- `/bearings file include PRs` combines the dated report with review and CI detail.
